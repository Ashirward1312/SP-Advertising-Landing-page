    ...
    >
      ...
      <div className="p-5 sm:p-6 pb-0">
        <div className="flex items-center gap-3">
          ...
          <h3 className="heading-font text-lg font-semibold text-slate-900 uppercase">
            {item.title}
          </h3>
        </div>
      </div>
      ...
      <div className="px-5 sm:px-6 pb-5 sm:pb-6">
        <p className="paragraph-font mt-3 text-sm text-slate-600 leading-relaxed">
          {item.desc}
        </p>
        ...
        <div className="mt-4 flex items-center justify-between">
          <a
            href="#contact"
            className="inline-flex items-center gap-2 rounded-lg bg-orange-500 px-3.5 py-2 text-sm font-semibold text-white shadow-md shadow-orange-500/20 transition hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-300 uppercase"
          >
            CONTACT US
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-orange-50 px-3 py-1 text-xm font-medium text-orange-700 ring-1 ring-orange-200 uppercase">
            OUR SERVICES
          </span>
          <h2 className="heading-font mt-3 text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 uppercase">
            EVERYTHING YOU NEED FOR A SMOOTH PROPERTY JOURNEY
          </h2>
          <p className="paragraph-font mt-2 text-slate-600">
            From Discovery To Documentation — We Handle It All With Transparency
            And Speed.
          </p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {SERVICES.map((s, i) => (
            <ServiceCard
              key={s.id}
              item={s}
              delay={prefersReducedMotion ? 0 : 100 * i}
            />
          ))}
        </div>
      </div>
