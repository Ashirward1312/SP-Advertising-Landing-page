      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          {[
            {
              title: "Transparency",
              desc: "No hidden charges. Real insights. Honest process.",
              icon: (
                <svg
                  width="18"
                  height="18"
            ...
            {
              title: "Support",
              desc: "We guide you through every step with care.",
              icon: (
                <svg
                  width="18"
                  height="18"
                ...
                >
                  <path
                    d="M20 8a8 8 0 1 1-16 0"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="1.7"
                  />
                  <path d="M12 12v5" stroke="currentColor" strokeWidth="1.7" />
                </svg>
              ),
            },
            {
              title: "Security",
              desc: "Verified agents, secure data, and trusted systems.",
              icon: (
                <svg
                  width="18"
                  height="18"
            ...
            <div
              key={v.title}
              className="rounded-2xl bg-white ring-1 ring-slate-200 p-5 hover:shadow-lg transition"
            >
